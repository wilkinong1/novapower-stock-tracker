...
invoices_year = pd.read_csv('novapower-stock-tracker/streamlit_app_demo/invoices_year.csv')
items = pd.read_csv('novapower-stock-tracker/streamlit_app_demo/items.csv')
purchases = pd.read_csv('novapower-stock-tracker/streamlit_app_demo/purchases.csv')
with_incoming = pd.read_csv('novapower-stock-tracker/streamlit_app_demo/with_quantity.csv')
